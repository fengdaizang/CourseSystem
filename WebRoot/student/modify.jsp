				...
				<div class="tabbable" id="tabs-658239">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="panel-421509">
							<form action="/CourseSystem/studentServlet" class="form-horizontal" role="form">
								<input name="sid" value="<%=student.getSid()%>" type="hidden">
								<input name="method" value="modifyInfo" type="hidden">
								<div class="form-group">
									 <label class="col-sm-4 control-label">姓名</label>
									<div class="col-sm-4">
										<input class="form-control"  name="sname" type="text" value="<%=student.getSname() %>" />
									</div>
								</div>
								<div class="form-group">
									 <label class="col-sm-4 control-label">年龄</label>
									<div class="col-sm-4">
										<input class="form-control" name="age" type="text" value="<%=student.getAge() %>" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-offset-4 col-sm-4">
										 <a href="student/right.jsp">返回上一级</a>
									</div>
								</div>
							</form>
						</div>
						<div class="tab-pane" id="panel-593721">
							<form class="form-horizontal" action="/CourseSystem/studentServlet" role="form" onsubmit="return checkFrom()" >
								<input name="sid" value="<%=student.getSid()%>" type="hidden">
								<input name="method" value="modifyPassword" type="hidden">
								<input value="<%=student.getPassword() %>" id="oldpassword1" type="hidden" />
								<div class="form-group">
