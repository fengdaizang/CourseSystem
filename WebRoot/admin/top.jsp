<%@page import="com.course.bean.Admin"%>
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div class="alert alert-success alert-dismissable">
					 <a style="float: right;" href="/CourseSystem/adminServlet?method=logout" target="_top">
					 	<img src="<%=path%>/images/out.gif" alt="安全退出" width="46" height="20" border="0">
					 </a>
					 <h3 style="margin-left: 40%;"><%=admin.getUsername()%>管理员，您好：欢迎使用课设管理与分析系统</h3>
				</div>
			</div>
		</div>
	</div>
