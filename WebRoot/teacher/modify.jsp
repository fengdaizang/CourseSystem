				...
				<div class="tabbable" id="tabs-658239">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="panel-421509">
							<form action="/CourseSystem/teacherServlet" class="form-horizontal" role="form">
								<input name="tid" value="<%=teacher.getTid()%>" type="hidden">
								<input name="method" value="modifyInfo" type="hidden">
								<div class="form-group">
									 <label class="col-sm-4 control-label">姓名</label>
									<div class="col-sm-4">
										<input class="form-control"  name="tname" type="text" value="<%=teacher.getTname() %>" />
									</div>
								</div>
								<div class="form-group">
									 <label class="col-sm-4 control-label">电话</label>
									<div class="col-sm-4">
										<input class="form-control" name="tphone" type="text" value="<%=teacher.getTphone() %>" />
									</div>
								</div>
								<div class="form-group">
									 <label class="col-sm-4 control-label">邮箱</label>
									<div class="col-sm-4">
										<input class="form-control" name="temail" type="text" value="<%=teacher.getTemail() %>" />
									</div>
								</div>
								<div class="form-group">
						...
						<div class="tab-pane" id="panel-593721">
							<form class="form-horizontal" action="/CourseSystem/teacherServlet" role="form" onsubmit="return checkFrom()" >
								...
								<input value="<%=teacher.getPassword() %>" id="oldpassword1" type="hidden" />
								<div class="form-group">
